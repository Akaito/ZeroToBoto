...
{% include spoiler-hint.html major=0 minor=1
	summary="How to get the \"Guess my number\" prompt"
	details="
...
{% include spoiler-hint.html major=0 minor=2
	summary="<code>str</code> vs. <code>int</code>"
	details="
...
{% include spoiler-hint.html major=0 minor=3
	summary="How to use the user's input later"
	details="
		Store the result of <code>raw_input</code> in a variable.  <code>guess = raw_input()</code>.
" %}
{% include spoiler-hint.html major=0 minor=4
	summary="<code>True</code> and <code>False</code> aren't printing"
	details="
